    ...
    <div class="login">
        ...
        <form action="log_in.php" method="POST">
            ...
            <div class="namesurname">
                ...
                <input type="text" class="input" name="namesurname" id="namesurname" maxlength="30" size="20" placeholder="Dylan Davsen" required>
            </div>

            <div class="password_2">
                <label for="password">Password:</label>
                <input type="password" class="input" name="password" id="password_2" maxlength="15" size="20" placeholder="paSSword123" required>
            </div>
